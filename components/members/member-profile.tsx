...
export default function MemberProfile({
  ...
  const [
    ...
    setWhatsAppPreferenceSaved,
  ] = useState(false);

  async function changeWhatsAppPreference(
    value:
      | "whatsapp"
      | "whatsapp_business"
  ) {
    ...
    try {
      ...
      setWhatsAppPreferenceError(
        error instanceof Error
          ? error.message
          : "Unable to save WhatsApp preference."
      );
    } finally {
      setSavingWhatsAppPreference(
        false
                ...
                {memberWhatsAppUrl && (
                  <div className="mt-4 space-y-3">
                    ...
                    <div className="max-w-xs">
                      ...
                      <label
                        htmlFor="preferred-whatsapp-app"
                      ...
                      <select
                        ...
                        onChange={(
                          ...
                          void changeWhatsAppPreference(
                            event.target.value as
                              | "whatsapp"
                              | "whatsapp_business"
                          );
                        }}
                        className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm font-bold text-slate-800 outline-none transition focus:border-emerald-500 disabled:cursor-not-allowed disabled:opacity-60"
                      >
